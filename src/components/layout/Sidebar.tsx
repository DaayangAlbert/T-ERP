  ...
  return (
    <aside
      className={clsx(
        ...
        "bg-sidebar-bg text-sidebar-text border-r border-[#1F1230]",
        "transition-[width] duration-200",
        sidebarCompact ? "w-16" : "w-[220px]"
      )}
    >
      {/* Toggle */}
      <div className={clsx("flex items-center border-b border-white/8 py-1.5 px-2.5", sidebarCompact && "justify-center px-0")}>
        <button
        ...
        >
          <ChevronLeft className={clsx("h-4 w-4 transition-transform", sidebarCompact && "rotate-180")} />
        </button>
      </div>
        ...
        <div key={section.title}>
          <div
            className={clsx(
              ...
              sidebarCompact && "border-t border-white/8 mt-2 pt-2 text-transparent text-[0px] px-0"
            )}
          >
            {section.title}
          </div>
            ...
            return (
              <Link
                ...
                className={clsx(
                  ...
                  sidebarCompact && "justify-center px-0 py-2.5"
                )}
              >
                ...
                {item.badge && (
                  <span
                    className={clsx(
                      ...
                      sidebarCompact && "absolute right-2 top-1 px-1 text-[9px]",
                      item.badge.alert
