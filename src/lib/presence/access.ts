 ...
 * - Consultation de tous les pointages : DG + PCA + RH.
 * - Consultation de son chantier : Chef de chantier (SITE_MANAGER).
 */
...
const VIEW_ALL_ROLES: Role[] = [Role.OWNER, Role.DG, Role.HR];
