    ...
    <div className="space-y-3">
      ...
      <section className="rounded-xl border border-line bg-white">
        ...
        <div className="grid gap-2 p-3 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { label: "Marchés & contrats", href: "/sg/marches", icon: ScrollText, count: contracts },
            { label: "CA & Gouvernance", href: "/sg/gouvernance", icon: Landmark, count: 2 },
            { label: "Contentieux", href: "/sg/contentieux", icon: Gavel, count: activeCases },
            { label: "Conformité", href: "/sg/conformite", icon: Scale, count: registersCount },
            { label: "Institutionnel", href: "/sg/institutionnel", icon: Briefcase, count: 8 },
            { label: "Courriers officiels", href: "/sg/courriers", icon: Mail, count: pendingCorrespondences + 3 },
          ].map((f) => {
            const Icon = f.icon;
            return (
              <div
