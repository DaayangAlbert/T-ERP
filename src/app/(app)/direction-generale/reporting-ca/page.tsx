      ...
      <section className="mb-6">
        ...
        <div className="grid gap-3.5 lg:grid-cols-3">
          ...
          <BoardReportTemplateCard
            ...
            href="/direction-generale/reporting-ca/nouveau?type=QUARTERLY"
          />
          <BoardReportTemplateCard
            ...
            href="/direction-generale/reporting-ca/nouveau?type=ANNUAL"
          />
        </div>
      </section>
                  ...
                  >
                    ...
                    <td className="py-2.5 pr-4">
                      <div className="flex justify-end gap-1">
                        <Link
                          href={`/direction-generale/reporting-ca/${r.id}`}
                        ...
                        <Link
                          href={`/direction-generale/reporting-ca/${r.id}?diffuser=1`}
                          className="grid h-7 w-7 place-items-center rounded text-ink-3 hover:bg-surface-alt hover:text-primary-700"
                          title="Diffuser"
                        >
